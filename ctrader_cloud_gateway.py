...
CTRADER_CONFIG = {
    "client_id": os.getenv("CTRADER_CLIENT_ID", "39195_4Gr4AwHTdQX7XVxMccP1mfzwU9RE99BDPQCiF6Y5vGotQpwdtC").strip('"').strip(),
    "client_secret": os.getenv("CTRADER_CLIENT_SECRET", "2hV6fK7gHwQcdNkmLyazI1xA84Xmps5GezuCh3xJo9FMD9yqpF").strip('"').strip(),
